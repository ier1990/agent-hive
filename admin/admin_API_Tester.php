...
// Defaults
$defaultUrl = isset($_GET['url']) ? (string)$_GET['url'] : 'https://localhost/v1/chat';
...
<body>
	...
	<div class="note">Use this tool to test endpoints like <code>https://localhost/v1/chat</code> or OpenAI-compatible APIs. Provide headers (e.g., Authorization) as needed.</div>

	<form method="post" class="card" autocomplete="off">
		<input type="hidden" name="csrf" value="<?php echo h($csrf); ?>">
		<div class="row">
			<label for="url" class="w-100">Request URL</label>
			<input type="text" id="url" name="url" value="<?php echo h($defaultUrl); ?>" placeholder="https://localhost/v1/chat">
		</div>
		<div class="grid">
			<div>
